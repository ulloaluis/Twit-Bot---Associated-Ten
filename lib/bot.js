...
const trending = "Statue of Liberty"; //trend used for top tens, can be hashtag/word/phrase/mention etc.
...
//source: https://stackoverflow.com/a/42113559
//adding more overly common words
fs.readFile('./moreWords.txt', 'utf-8', (err, file) => {
  const lines = file.toString().split('\n')

  for (let line of lines)
    excludedWords.push(line);
});
