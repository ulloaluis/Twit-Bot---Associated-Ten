...
const trending = "Brock"; //trend used for top tens, can be hashtag/word/phrase/mention etc.
 ...
 *
 */
let jsonDataFile = JSON.parse(fs.readFileSync("/Users/luisulloa/desktop/twitter/dataFile.json", "utf8")); //parse is synchronous!
let excludedWords = SortedSet(jsonDataFile.bannedList); //remove duplicates and apply preferrable storing method
